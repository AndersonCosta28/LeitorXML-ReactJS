...
export default function Relatorio({ route, navigation }) {
    ...
    const [Todos_Os_Eventos, setEventos] = useState([])

    useEffect(() => {
        const [Soma_Dia, Todas_As_Notas, Total, Soma_CFOP, total_de_erros, Todos_Os_Eventos] = route.params.DadosDoBackEnd;
        ...
        <div>
            ...
            <div className="row align-items-center" style={{ marginTop: '3%' }}>
                ...
                <div className="table1 col">
                    <input type="button" value="Gerar PDF" onClick={() => pdf(Todas_As_Notas, Total, Soma_CFOP, Todos_Os_Eventos)}></input>
                </div>
                <div className="table1 col">
                    <input type="button" value="Gerar XLS" onClick={() => navigation.navigate('xls', { Todas_As_Notas })}></input>
                </div>
            </div>
            ...
            <div className='row'>
                <Evento Eventos={Todos_Os_Eventos} estilo="table2 col" />
            </div>
            <div className="row">
